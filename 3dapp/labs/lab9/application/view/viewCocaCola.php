...
<head>
    ...
    <!-- X3dom -->
    <link rel='stylesheet' type='../application/text/css' href='css/x3dom.css'>
    ...
    <div class="container-fluid main_contents"> <!-- Start SPA Contents -->
        ...
        <div id="home">
          <video autoplay muted loop class="video-background">
              <source src="../application/assets/videos/coca_cola.mp4" type="video/mp4">
          </video>
          <div class="overlay"></div>
          <div id="main_text">
              <h8>When Coca-Cola is a Part of Your Life</h8>
              <p><h9>You Can’t Beat the Feeling</h9></p>
                ...
                <div class="col-md-12">
                    <div class="card card-custom bg-light">
                        <div class="row no-gutters">
                            <div class="col-md-4">
                                <img src="../application/assets/images/site_images/coca_cola.jpg" class="card-img-left" alt="Coca Cola">
                            </div>
                            <div class="col-md-6">
                                <div class="card-body">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card card-custom bg-light">
                        <div class="row no-gutters">
                            <div class="col-md-4">
                                <img src="../application/assets/images/site_images/sprite.jpg" class="card-img-left" alt="Sprite">
                            </div>
                            <div class="col-md-6">
                                <div class="card-body">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card card-custom bg-light">
                        <div class="row no-gutters">
                            <div class="col-md-4">
                                <img src="../application/assets/images/site_images/dr_pepper.jpg" class="card-img-left" alt="Dr Pepper">
                            </div>
                            <div class="col-md-6">
                                <div class="card-body">
        ...
        <div id="models">
            ...
            <div class="row">
                ...
                <div class="col-sm-8">
                    <div class="card text-left transparent-card h-100">
                  ...
                  <div class="col-sm-4">
                      <div class="card text-left transparent-card">
                          <div class="card-header">
                            <ul class="nav nav-tabs card-header-tabs">
                            <!-- Dropdown nav-tab -->
          ...
          <div id="cokeDescription" class="row">
              <div class="col-sm-12">
                  <div class="card">
                      <div class="card-body">
                          <h3 id="title_coke" class="card-title drinksText">Coca-Cola</h3>
                          <h5 id="subTitle_coke" class="card-subtitle drinksText">Refreshing Taste</h5>
                          <p id="description_coke" class="card-text drinksText">Coca-Cola is a carbonated soft drink sold in stores, restaurants, and vending machines worldwide. It is produced by The Coca-Cola Company.</p>
          ...
          <div id="spriteDescription" class="row">
              <div class="col-sm-12">
                  <div class="card">
                      <div class="card-body">
                          <h3 id="title_sprite" class="card-title drinksText">Sprite</h3>
                          <h5 id="subTitle_sprite" class="card-subtitle drinksText">Lemon-Lime Flavor</h5>
                          <p id="description_sprite" class="card-text drinksText">Sprite is a colorless, lemon and lime-flavored soft drink created by The Coca-Cola Company. It was first developed in West Germany in 1959.</p>
          ...
          <div id="pepperDescription" class="row">
              <div class="col-sm-12">
                  <div class="card">
                      <div class="card-body">
                          <h3 id="title_pepper" class="card-title drinksText">Dr. Pepper</h3>
                          <h5 id="subTitle_pepper" class="card-subtitle drinksText">Unique Flavor</h5>
                          <p id="description_pepper" class="card-text drinksText">Dr Pepper is a carbonated soft drink. It was created in the 1880s by pharmacist Charles Alderton in Waco, Texas, and first served around 1885.</p>
